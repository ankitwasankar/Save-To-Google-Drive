...
3. Enable the Google Drive API  (If not already done) as you will require the client_id, client_secret and uri <br>
    a. Refer link: <a href='https://developers.google.com/drive/web/quickstart/quickstart-php' target='_blank'>Enable Google Drive API</a> 
4. Finally edit the following details in the file:<br>
    ...
    c. Edit &lt;URL_OF_SAME_PAGE_THAT_IS_LinkUploadToGoogleDrive.php&gt;  <br>
